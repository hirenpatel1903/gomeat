...
<div class="card-header card-header-primary">
   <div class="row">
    <div class="col-md-4">
      <h1 class="card-title"><b>{{ __('keywords.Stores')}}  {{ __('keywords.Notification')}} {{ __('keywords.List')}}</b></h1>
      </div>
       <div class="col-md-8">
           
      <a href="{{route('delete_all_store_not')}}" class="btn btn-danger p-1 ml-auto" style="float:right;"  onClick="return confirm('Are you sure you want to permanently remove all Store Notifications')" ><i class="fa fa-trash"></i> {{ __('keywords.All')}}</a> &nbsp; &nbsp;
...
<table id="datatableDefault" class="table table-responsive table-striped text-nowrap w-100">
    <thead class="thead-light">
        <tr>
            ...
            <th  class="text-center" style="width:20% !important">{{ __('keywords.Store')}}</th>
