...
<div class="card-header card-header-primary">
   <div class="row">
    <div class="col-md-4">
      <h1 class="card-title"><b>{{ __('keywords.Users')}} {{ __('keywords.Notification')}} {{ __('keywords.List')}}</b></h1>
      </div>
       <div class="col-md-8">
           
      <a href="{{route('delete_all_user_not')}}" class="btn btn-danger p-1 ml-auto" style="float:right;"  onClick="return confirm('Are you sure you want to permanently remove all Users Notifications')" ><i class="fa fa-trash"></i> {{ __('keywords.All')}}</a> &nbsp; &nbsp;
      
        <a href="{{route('delete_read_user_not')}}" class="btn btn-danger p-1 mr-1 ml-auto" style="float:right;"  onClick="return confirm('Are you sure you want to permanently remove all rad by user Notifications')" ><i class="fa fa-trash"></i> {{ __('keywords.Read by user')}}</a>
      </div>
       </div>
</div>
