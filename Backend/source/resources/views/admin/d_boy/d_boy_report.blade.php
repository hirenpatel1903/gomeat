...
<table id="datatableDefaultt1" class="table text-nowrap w-100 table-striped">
...
<div class="container"> <br> 
<table id="datatableDefaults" class="table text-nowrap w-100 table-striped">
    <thead class="thead-light">
        <tr>
            <th class="text-center">#</th>
                      <!--<th>ID</th>-->
...
<div class="container"> <br> 
<table id="datatableDefault1" class="table text-nowrap w-100 table-striped">
    <thead class="thead-light">
        <tr>
            <th class="text-center">#</th>
                      <!--<th>ID</th>-->
...
<div class="container"> <br> 
<table id="datatableDefault2" class="table text-nowrap w-100 table-striped">
    <thead class="thead-light">
        <tr>
            <th class="text-center">#</th>
                      <!--<th>ID</th>-->
...
<div class="container"> <br> 
<table id="datatableDefaults3" class="table text-nowrap w-100 table-striped">
    <thead class="thead-light">
        <tr>
            <th class="text-center">#</th>
                      <!--<th>ID</th>-->
...
<div class="container"> <br> 
<table id="datatableDefaults2" class="table text-nowrap w-100 table-striped">
    <thead class="thead-light">
        <tr>
            <th class="text-center">#</th>
                      <!--<th>ID</th>-->
