          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form class="forms-sample" action="{{route('sec_banneradd')}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                   ...
                   <div class="col-md-12">    
                      <div class="form-group">
                          ...
                          <select name="varient_id" class="form-control">
        		          	...
        		          	<option value="{{$categorys->varient_id}}">{{$categorys->product_name}} ({{$categorys->quantity}} {{$categorys->unit}})</option>
        		              @endforeach
