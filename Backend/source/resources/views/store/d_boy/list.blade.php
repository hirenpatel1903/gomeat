...
<div class="card-header card-header-primary">
    ...
    <div class="col-md-6">
      <h5 class="card-title"><b>{{ __('keywords.Delivery Boy')}} {{ __('keywords.List')}}</b></h5>
       ...
       <div class="col-md-6">
      <a href="{{route('store_AddD_boy')}}" class="btn btn-primary p-1 ml-auto" style="width:15%;float:right;padding: 3px 0px 3px 0px;">{{ __('keywords.Add')}}</a>
      </div>
       </div>
    </div>
...
<table id="datatableDefault" class="table table-striped text-nowrap w-100">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="{{$url_aws.$d_boys->id_photo}}"><img src="{{$url_aws.$d_boys->id_photo}}" style="width:50px;height:50px;border-radius:50%"  alt="image"></a></td> 
