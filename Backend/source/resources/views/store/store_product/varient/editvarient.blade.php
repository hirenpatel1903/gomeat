            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <form class="forms-sample" action="{{route('storeupdate-varient', $varient_id)}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                </div>
                <div class="card-body">
                    ...
                    <a href="{{route('storevarient',$product->product_id)}}" class="btn">{{ __('keywords.Close')}}</a>
