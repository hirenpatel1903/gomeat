            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <form class="forms-sample" action="{{route('storeAddNewvarient')}}" method="POST" enctype="multipart/form-data">
                      {{csrf_field()}}
                </div>
                <div class="card-body">
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" step="0.01" class="form-control" id="exampleInputName1" name="mrp" placeholder="Enter MRP" value="{{old('mrp')}}" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
